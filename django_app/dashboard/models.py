...
class SystemConfig(models.Model):
    ...
    logo = models.ImageField(
        'Логотип (в шапке)', upload_to='logo/', null=True, blank=True,
        help_text='Изображение в шапке рядом с надписью «Молвест.Учет.Продукции» '
                  'вместо иконки-коробки. Рекомендуется PNG с прозрачностью, '
                  'высота ~30–40 px. Если не загружено — показывается иконка.',
    )
